...
| `/task-v2-summary`[^summary-ac-infeasible] | issue body + git diff | process-summary comment (AC mapping), commit message, PR body, OR `AC_INFEASIBLE` verdict with `infeasible_acs` array (see footnote) | ~10 min |
