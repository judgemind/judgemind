...
| `/task-v2-ralph`[^ralph-subagent] | plan from above, worktree path | SHIP verdict + implementation diff in git | ~45-90 min (multi-invocation internally, same as today) |
