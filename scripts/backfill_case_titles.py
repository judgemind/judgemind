...
# Ensure the scraper-framework source is importable (for local dev / tests).
# On ECS the package is installed, so this is a no-op.
...
from ingestion.extract import extract_case_title  # noqa: E402
