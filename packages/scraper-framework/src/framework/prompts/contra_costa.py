...
CONTRA_COSTA_SYSTEM_PROMPT = (
    ...
    "- `N##-####` -- typically name change / probate (e.g., N25-2307); "
    "but **infer case_type from context, not just the prefix** -- "
    "N-prefix cases that appear on civil-department master "
    "calendar PDFs (Format A, e.g. Dept 14, 32, 34) with "
    "plaintiff-v-defendant case titles are CIVIL.  Use `civil` "
    "when the case_title matches `<plaintiff> v. <defendant>` "
    "structure or the parent department is a civil department, "
    "regardless of the N prefix (#4291).\n"
