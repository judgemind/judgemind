...
RIVERSIDE_SYSTEM_PROMPT = (
    ...
    "For 'Off calendar' or 'Taken off calendar' entries, use 'off_calendar'.\n"
    "**DROP rule**: If a per-entry ruling body is ONLY a 'No tentative ruling.' "
    "variant (e.g. 'No tentative ruling.', 'No tentative ruling, appearances "
    "required.', 'No further tentative ruling.') with 200 characters or fewer "
    "of total content, OMIT that entry entirely — do NOT include it in the "
    "rulings array. Exception: if the entry continues with more than 200 "
    "characters of substantive legal analysis after 'No tentative ruling', "
    "keep it with outcome='other'.\n\n"
    "## Output format\n\n"
