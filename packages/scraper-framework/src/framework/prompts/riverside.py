...
RIVERSIDE_SYSTEM_PROMPT = (
    ...
    "headings. WRONG: 'WILLARD VS HYUNDAI MOTOR AMERICA vs. MOTION FOR "
    "ATTORNEY'S FEES BY JAMES WILLARD'. RIGHT: 'Willard v. Hyundai Motor "
    "America'. If a second 'v.' or 'vs.' token appears in the title "
    "followed by any of: Motion, Msc, Petition, Demurrer, MSJ, Hearing on, "
    "To Be Relieved, To Set Aside, To Compel, For Attorney, For Summary — "
    "that is a motion description that leaked into the title. Stop the "
    "title at the first 'v.'/'vs.' separator and omit everything after.\n"
