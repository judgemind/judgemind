...
describe('verifyPassword', () => {
  ...
  describe('bcryptjs v2 hash backward compatibility', () => {
    // Hash generated by bcryptjs v2 for plaintext 'password' at cost 5.
    // This is a published bcrypt test vector (bcrypt spec, $2a$ variant).
    // Regression guard: v3 must still verify hashes created by v2.
