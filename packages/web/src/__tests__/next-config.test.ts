 ...
 *
 * isomorphic-dompurify must be listed in serverExternalPackages (Next 15;
 * formerly experimental.serverComponentsExternalPackages in Next 14)
...
describe('next.config.js', () => {
  it('externalises isomorphic-dompurify and jsdom for server-side rendering', () => {
    ...
    const externals = nextConfig.serverExternalPackages ?? [];
